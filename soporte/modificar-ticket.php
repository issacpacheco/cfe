...
<li class="nav-item">
    ...
    <form class="user" id="combo" name="combo" action="modificar.php?id=<?php echo $id_ticket ?>" method="POST">
                        <div class="form-group">
                                <a> Solicitante: </a>
                                <input name="txt_solicitante" class="form-control form-control-user" value="<?php echo $row['solicitante']; ?>">
                        </div>
                        <div class="form-group">
                                <a> Referencia: </a>
                                <input name="txt_licencia" class="form-control form-control-user" value="<?php echo $row['licencia']; ?>">
                        </div>
                        <div class="form-group">
                                <a> Telefono: </a>
                                <input name="txt_cel" class="form-control form-control-user" value="<?php echo $row['celular']; ?>">
                        </div>
                        <div class="form-group">
                                <a> Correo: </a>
                                <input  name="txt_correo" class="form-control form-control-user" type="email" value="<?php echo $row['correo']; ?>">
                        </div>
                                <a> Zona: </a>
                                <select class="form-control" aria-label="Default select example" name="cbx_zona" id="cbx_zona">
                                <option value="0"></option>
                                <?php $query = "SELECT ID, ZONA FROM resp_zona"; $resultado=$mysqli->query($query); while($row = $resultado->fetch_assoc()) { ?>
