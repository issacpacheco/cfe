...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="container-fluid">
                             <form class="user" id="combo" name="combo" action="guardar-servicio.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                                <div>Ticket: <input class="form-control form-control-user" type="" value="<?php echo $id_ticket ?>" name="id_ticket"></div>
                        </div>
                            <div>Seleccione servicio : <select  class="form-control" name="cbx_servicio" id="cbx_servicio">
            ...
            <div>Foto:<input class="form-control" type="file" accept="image/*" name="fileToUpload1" value=""></div>

            <div>Foto:<input class="form-control" type="file" accept="image/*" name="fileToUpload2" value=""></div>
