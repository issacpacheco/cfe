  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li ><a href="../conexion/logout.php">Cerrar sesion <span class="sr-only">(current)</span></a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
...
<div class="container">
  <div class="row">
    <div class="col-md-11">
       ...
       <a href="../menu_soporte.php"> <button type='button' class='btn btn-success'>Regresar</button> </a>
    </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="color" class="form-control" id="color">
										...
										<option style="color:#228B22;" value="#228B22">CFE</option>		
										<option style="color:#436EEE;" value="#436EEE">AYUNTAMIENTO</option>
										<option style="color:#8B0000;" value="#A020F0">GPS</option>
