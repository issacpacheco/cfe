                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div href="login.html" class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               <a class="" href="nuevo_ticket.html">Nuevo ticket</a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a class="" href="tickets_usuario.html">Mis tickets</a>
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
