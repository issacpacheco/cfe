...
<thead>
        ...
        <?php
      include "../conexion.php";
      $sentencia="SELECT SUM(tr.subtotal) AS total, t.*, r.* FROM trabajos tr LEFT JOIN ticket t ON tr.id_ticket = t.id_tickets LEFT JOIN resp_zona r ON t.zona = r.ID_ZONA WHERE t.id_tickets = '$id_ticket'";
      ...
      while($filas=mysqli_fetch_assoc($resultado))
      {
        ...
        $total=$filas['total'];
        $ID_ZONA=$filas['ID_ZONA'];
        echo "<tr>";
          echo "<td><input name='id_ticket' value='".$ticket."'>"; echo "</td>";
          echo "<input type='hidden' name='total' value='".$total."'>"; echo "";
          echo "<input type='hidden' name='idzona' value='".$ID_ZONA."'>"; echo "";
