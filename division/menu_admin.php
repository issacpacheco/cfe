                                        ...
                                        <div class="table-responsive">
                                            <table style="text-align: center;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>$ <?php echo number_format($presupuesto2,2,'.',',');  ?></td>
                                                    <td>$ <?php echo number_format($total,2,'.',',');  ?></td>
                                                    <td>$ <?php echo number_format($ejecutado,2,'.',',');  ?></td>
                                                    <td>$ <?php echo number_format($ampliacion,2,'.',',');  ?></td>
                                                    <td>$ <?php echo number_format($presupuesto,2,'.',',');  ?></td>
                                                    <td><a href="tickets_usuario.php?id=<?php echo $rowT['zona'] ?>"> <button type='button' class='btn btn-success'>Ver</button> </a> </td>
                                                </tbody>
                                                <?php } } ?>
                                            </table>
                                        </div>
