...
<?php
  ...
  $consulta=ConsultarProducto($_GET['id_ticket']);

  function ConsultarProducto($id_ticket)
  {
    include "../conexion.php";
    echo $id_ticket;
    $sentenciaS="SELECT * FROM ticket WHERE id_tickets='".$id_ticket."'";
    $resultadoS=$mysqli->query($sentenciaS);
...
<li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="agregar_usuario.php">Usuario</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tickets de usuario</h1>
    ...
    <div style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px;">
        <span> <h1>Modificar estado</h1> </span>
        <br>
      <form action="modificar.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
      <input type="hidden" name="id_ticket" value="<?php echo $_GET['id_ticket']?> ">
        <label>Estado: </label>
